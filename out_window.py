...
class Ui_OutputDialog(QDialog):
    def __init__(self):
        ...
        loadUi("code\outputwindow.ui", self)
        self.image = None
    ...
    def startVideo(self, camera_name):
        ...
        :return:
        """
        #camera_name="https://192.168.100.175:8080/video"
    ...
    def face_rec_(self, frame, encode_list_known, class_names):
        ...
        def mark_attendance(name):
            ...
            :return:
            """
            with open('C://Users\SHUBHAM_2018\Desktop\intership attendance system\code\Attendance.csv', 'a') as f:
    ...
    def displayImage(self, image, encode_list, class_names, window=1):
        ...
        for encodeFace in encode_list:
            ...
            match = face_recognition.compare_faces(encode_list, encodeFace, tolerance=0.60)
